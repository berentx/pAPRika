...
def create_dg_plots(restraints, results):
    ...
    initial_distance = restraints[0].pull['target_initial'].m
    final_distance = restraints[0].pull['target_final'].m
    dr = 0.5
...
def analysis(args):
    ...
    convergence = get_fe_convergence(free_energy.results, method="ti-block")
